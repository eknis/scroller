...
// このjsファイルを修正する際は「language-message-submenu.js」にも同様の修正を加える必要があるか必ず確認する
      ...
      , j = b.Model.extend({
        ...
        parse: function(c) {
            ...
            if (c) {
                ...
                q && !a.isEmpty(q.langMsg) && (q.submenu_view ? require(["util/language-message-submenu"], function(a) {
                    a.setMessage(q.langMsg)
                }) : f.setMessage(q.langMsg))
            }
            return c
        },
      ...
      , m = c.Model.extend({
        ...
        playTownBGM: function(a) {
            ...
            if (h.isSupported()) {
                ...
                var d = h.get("mypage_char_bgm_" + c);
                if (d && "default" != d)
                    return void b.playBGM("bgm/" + d)
            }
        ...
        playQuestMapBGM: function(a, c) {
            ...
            if (a) {
                ...
                return d._getSoundData("rest/sound/quest_map_bgm?" + e, function(a) {
                    d.playBGM(a)
                })
            }
        ...
        playMypageVoice: function(a) {
            var b = this;
            b._getSoundData("rest/sound/mypage_voice?data=" + a, a, function(a) {
                b.playVoice(a)
            })
        },
        ...
        playArchiveVoice: function(a) {
            var b = this;
            b._getSoundData("rest/sound/archive_voice?data=" + a, a, function(a) {
                b.playVoice(a, {
                    force: !0
                })
            })
        ...
        playFormationVoice: function(a) {
            var b = this;
            b._getSoundData("rest/sound/formation_voice?data=" + a, a, function(a) {
                b.playVoice(a)
            })
        },
    ...
    var d = 0
      , e = b.View.extend({
        ...
        popShow: function(a, b) {
            ...
            e.css("display", "block");
            var f = this.$el.find(".pop-usual")
              , g = this;
            c.playPopShowSE(f);
            var h = this.options.showEndCallback;
            h && f.oneTransitionEnd(function() {
                f.off("transitionend webkitTransitionEnd"),
                h()
            }, 300);
            var i, j = Number($("html").height()), k = Number($("html").css("zoom")), l = $(document).scrollTop();
            Game.ua.isJssdk() && (j = Number($("#mobage-game-container").height()),
            k = 1 >= k ? Number($("#mobage-game-container").css("zoom")) : k,
            l = $("#mobage-game-container").parent().scrollTop());
            var m = $(window).height() / k
              , n = 50 * +k;
            if (0 < $("#debug").length && (n = n + +$("#debug").height() + 30),
            "undefined" != typeof a)
                i = b;
            else {
                var o = l / k;
            ...
            f.css({
                ...
                if (a)
                    ...
                    var b = i
                      , c = b + f.height()
                      , d = Game.ua.isChromeApp() && 100 > n ? 100 : n
                      , e = j - d;
                    c > e && (b = e - f.height()),
                    0 > b && (b = 0);
                    var h = +j - +f.height() - +n;
                    if (0 > h) {
                        var k = Math.abs(h)
                          ...
                          , m = +l + k + 50;
                        g.updatedWrapperMargin = !0,
                        g.updateWrapperMargin(1, m)
                    }
                    i != b ? (f.css("top", b + "px"),
                    setTimeout(function() {
                        f.removeClass("pop-hide").addClass("pop-show")
...
define("general", ["jquery", "underscore", "backbone", "constant", "setting", "model/data-loader", "lib/sound", "model/sound", "util/navigate", "util/touch", "general/chat", "util/ob"], function(a, b, c, d, e, f, g, h, i) {
    ...
    }).on("cgtouchmove cgtouchend", y, function(b) {
        var c = a(this);
        c.hasClass("lis-summon") || (c.removeClass("on"),
        a("#debug a").css("display", "")),
        a("input:focus").blur(),
        "touchmove" !== b.type && Game.ua.isIOS() && 10 === +Game.ua.os.version.split(".")[0] && a("#wrapper").find("select:focus").blur()
    }).on("tap", y, function(b) {
        var c = a(this);
        h.playButtonSE(c),
        Game.ua.isChromeApp() && b.preventDefault()
    }),
    Game.ua.isIOS() && 10 === +Game.ua.os.version.split(".")[0] && w.on("change", "select:focus", function() {
        a(this).blur()
    });
